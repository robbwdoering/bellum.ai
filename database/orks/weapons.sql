INSERT INTO war_weapon_profile (
faction, name,			ap,	damage,	range,	strength,	weapontype,	shots,	meaning
)VALUES
...
("orks", "kustom_mega-slugga",	-3,	"D3",	"12",	"8",	"Pistol",	"1",{
...
("orks", "grot-prod",	-1,	"1",	"0",	"+2",	"Melee",	"1",{}),
...
("orks", "wazbom_mega-kannon",	-3,	"D6",	"36",	"8",	"Heavy",	"D3",{
	-- If you roll one or more hit rolls of 1, the bearer suffers a mortal wound after all of this weapon's shots have been resolved. Blast.
	"type": "",
	"params":
}),
("orks", "teleport_mega-blasta",	-2,	"D3",	"24",	"8",	"Assault",	"3",{
	-- If a model suffers any unsaved wounds from this weapon and is not slain, roll a D6 at the end of the phase.  if the result is greater than that model's Wounds characteristic, it is slain.
	"type": "",
	"params":
}),
...
("orks", "smasha_gun",	-4,	"D6",	"48",	"*",	"Heavy",	"D3",{
	-- Instead of making a wound roll for this weapon, roll 2D6.  If the result is equal to or greater than the target's Toughness, the attack successfully wounds. Blast.
	"type": "",
	"params":
}),
...
("orks", "kustom_mega_kannon",	-3,	"D6",	"36",	"8",	"Heavy",	"D6",{
	-- If you roll one or more hit rolls of 1 for this weapon, the bearer suffers a mortal wound after all of this weapon's shots have been resolved. Blast.
	"type": "",
	"params":
}),
...
("orks", "deffstorm_mega-shoota",	-1,	"1",	"36",	"6",	"Heavy",	"18",{}),
...
("orks", "supa-gatler",	-2,	"1",	"48",	"7",	"Heavy",	"3D6",{
	-- See Psycho-Dakka-Blast!
	"type": "",
	"params":
}),
("orks", "supa-rokkit",	-3,	"D6",	"100",	"8",	"Heavy",	"D6",{
...
("orks", "supa-skorcha",	-2,	"1",	"24",	"6",	"Heavy",	"4D3",{
...
("orks", "supa-kannon",	-2,	"3",	"60",	"8",	"Heavy",	"2D6",{
	-- Blast
	"type": "",
	"params":
}),
...
("orks", "kustom_supa-rokkits",	-3,	"D6",	"100",	"8",	"Heavy",	"D6",{
	-- Blast
	"type": "",
	"params":
}),
("orks", "lifta-droppa",	,	"",	"48",	"",	"Heavy",	"D6",{
	-- Blast. This weapon hits automatically.  Each time an enemy unit is hit by this weapon, roll 2D6.  If the result equals or exceeds the target's Strength, it suffers a mortal wound.
	"type": "",
	"params":
}),
("orks", "huge_tusks",	-4,	"D3+3",	"0",	"User",	"Melee",	"1",{}),
("orks", "squiggoth_supa-kannon",	-2,	"3",	"60",	"8",	"Heavy",	"2D6",{
	-- Blast
	"type": "",
	"params":
}),
("orks", "supa-lobba",	-2,	"1",	"48",	"7",	"Heavy",	"3D6",{}),
...
("orks", "grot-guided_bomm",	-3,	"2",	"72",	"8",	"Heavy",	"2D6",{
...
("orks", "grot_guided_bomm_(fighta-bommer)",	-3,	"2",	"72",	"8",	"Heavy",	"2D6",{
...
("orks", "kustom_mega-zappa",	-3,	"D6",	"36",	"8",	"Heavy",	"3D3",{
	-- If you roll one or more hit rolls of 1 for this weapon, the bearer suffers a mortal wound after all of this weapon's shots have been resolved. Blast.
	"type": "",
	"params":
}),
...
("orks", "saw_blades",	-1,	"1",	"0",	"+1",	"Melee",	"1",{}),
("orks", "heavy_squig_launcha_-_bile_squig",	0,	"1",	"36",	"*",	"Assault",	"2D6",{
	-- This weapon always wounds on a 4+ unless it is targeting a VEHICLE or TITANIC unit, in which case it wounds on a 6+. Blast.
	"type": "",
	"params":
}),
("orks", "heavy_squig_launcha_-_bitey_squig",	-3,	"2",	"36",	"5",	"Assault",	"2",{}),
("orks", "heavy_squig_launcha_-_boom_squig",	-1,	"D3",	"36",	"6",	"Assault",	"2D3",{
	-- Blast
	"type": "",
	"params":
}),
("orks", "_squig_launcha_-_bile_squig",	0,	"1",	"36",	"*",	"Assault",	"D6",{
	-- This weapon always wounds on a 4+ unless it is targeting a VEHICLE or TITANIC unit, in which case it wounds on a 6+. Blast.
	"type": "",
	"params":
}),
("orks", "_squig_launcha_-_bitey_squig",	-3,	"2",	"36",	"5",	"Assault",	"1",{}),
("orks", "_squig_launcha_-_boom_squig",	-1,	"D3",	"36",	"6",	"Assault",	"D3",{
	-- Blast
	"type": "",
	"params":
}),
...
("orks", "krusha_kannon_-_boom_shell",	-2,	"2",	"60",	"8",	"Heavy",	"2D6",{
	-- Blast
	"type": "",
	"params":
}),
("orks", "krusha_kannon_-_tankhamma_shell",	-3,	"6",	"60",	"10",	"Heavy",	"1",{
	-- Each time an attack is made with this weapon against a VEHICLE unit, you can re-roll the hit roll.
	"type": "",
	"params":
}),
("orks", "krusha_kannon_-_scrap_kanister",	-1,	"1",	"18",	"5",	"Heavy",	"3D6",{
	-- Each time an attack is made with this weapon, that attack automatically hits the target.
	"type": "",
	"params":
}),
("orks", "krusha_kannon_-_blast_burna",	-1,	"1",	"48",	"5",	"Heavy",	"3D6",{
	-- Blast
	"type": "",
	"params":
}),
...
("orks", "mega-gatler",	-2,	"1",	"48",	"7",	"Heavy",	"4D6",{}),
("orks", "deffkannon",	-4,	"D6",	"24",	"10",	"Heavy",	"D6",{
	-- Blast
	"type": "",
	"params":
}),
...
("orks", "git-rippa",	-4,	"2",	"0",	"x2",	"Melee",	"1",{
...
("orks", "mega-choppa_(smash)",	-5,	"6",	"0",	"x2",	"Melee",	"1",{}),
("orks", "mega-choppa_(slash)",	-2,	"D3",	"0",	"User",	"Melee",	"1",{
	-- Make 3 hit rolls for each attack made with this weapon, instead of 1.
	"type": "",
	"params":
}),
...
("orks", "stompa_lifta-droppa",	-4,	"D3+3",	"48",	"*",	"Heavy",	"4D3",{
...
("orks", "snakebitez_-_brogs_buzzbomb",	-1,	"1",	"6",	"5",	"Grenade",	"3D6",{
...
("orks", "da_souped-up_shokka",	-5,	"D6",	"60",	"2d6",	"Heavy",	"2D6",{
	-- Each time this unit is chosen to shoot with, roll once to determine the Strength characteristic of this weapon. If the result is 11+ each successful hit inflicts D3 mortal wounds on the target in addition to any normal damage. Blast.
	"type": "",
	"params":
}),
("orks", "souped-up_speshul",	-1,	"1",	"30",	"4",	"Assault",	"15",{}),
...
("orks", "kustom_mega-blasta",	-3,	"D6",	"24",	"8",	"Assault",	"1",{
	-- If you roll one or more hit rolls of 1, the bearer suffers a mortal wound after all of the weapon's shots have been resolved
	"type": "",
	"params":
}),
